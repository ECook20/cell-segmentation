...
graphmerge1 correctness.pdf: A pdf of a proof of correctness for the graph merge algorithm used in the concavity merging stage. See Concavity Measure 3D.ipynb for the algorithm -- may be useful to look at while examining the proof. 


final_arr_ambrose.npy: The final segmented result of my algorithm with my preferred parameters on the Ambrose slice. Having it present in the cwd allows visualization/ground-truth comparison much quicker.
